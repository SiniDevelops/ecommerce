...
<html lang="en">
    <head>
        ...
        <title>Test Website E-Commerce</title>
                ...
                <div class="col-md-3 col-sm-6 business_content">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <button class="btn btn-primary add-to-cart-btn" data-name="<?php echo htmlspecialchars($row['Name']) ?>" data-price="<?php echo htmlspecialchars($row['Price']) ?>" data-image="<?php echo htmlspecialchars($row['ImageUrl']) ?>" style="margin-top: 10px;">Add to Cart</button>
                        </div>
                    </div>
                </div>
